...
Usage
-----
Add a `GraphQLBundle` to your [Application](http://www.dropwizard.io/1.3.5/dropwizard-core/apidocs/io/dropwizard/Application.html) class.
...
```
./mvnw clean package
java -jar graphql-example/target/graphql-example-1.3.5-3-SNAPSHOT.jar server graphql-example/hello-world.yml
```
